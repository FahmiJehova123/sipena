...
$page_title = 'ID Card Siswa - SIAKAD';
$current_page = 'idcard';
...
$nama_ayah = htmlspecialchars($user['nama_ayah'] ?? '-');
$nama_ibu = htmlspecialchars($user['nama_ibu'] ?? '-');
$wali = "$nama_ayah & $nama_ibu";
    ...
    <div class="main-content-container flex-1 transition-all duration-300 ease-in-out">
        <header class="bg-white dark:bg-gray-800 shadow-md sticky top-0 z-10">
            <div class="flex items-center justify-between px-4 py-3 md:px-6">
                ...
                <?php endif; ?>
                <h1 class="text-xl font-semibold text-gray-800 dark:text-white hidden md:block">ID Card Siswa</h1>
        ...
        <main class="p-4 md:p-6 dark:bg-gray-900 transition-colors">
            <div class="flex flex-wrap justify-center gap-6 mb-8">
                ...
                <div id="ktp-card-front" class="ktp-card">
                    <div class="card-header">KARTU TANDA SISWA</div>
                    <div class="card-body">
                        <div class="photo">
                            <?php if ($photo_url): ?>
                        ...
                        <table class="info-table">
                            ...
                            <tr><td class="info-label">NIS</td><td class="info-colon">:</td><td class="info-value"><?= $nis ?></td></tr>
                            <tr><td class="info-label">Tempat/Tgl Lahir</td><td class="info-colon">:</td><td class="info-value"><?= $tempat_lahir ?>, <?= $tanggal_lahir ?></td></tr>
                            <tr><td class="info-label">Kelas Pagi</td><td class="info-colon">:</td><td class="info-value"><?= $kelas_pagi ?></td></tr>
                            <tr><td class="info-label">Kelas Diniyyah</td><td class="info-colon">:</td><td class="info-value"><?= $kelas_diniyyah ?></td></tr>
                            <tr><td class="info-label">Alamat</td><td class="info-colon">:</td><td class="info-value"><?= $alamat ?></td></tr>
                            <tr><td class="info-label">Wali</td><td class="info-colon">:</td><td class="info-value"><?= $wali ?></td></tr>
                        </table>
                    </div>
                    <div class="footer">Berlaku selama masa studi</div>
                </div>

                <!-- Card Belakang (QR) -->
                <div id="ktp-card-back" class="ktp-card">
                    <div class="card-header">KARTU TANDA SISWA (Belakang)</div>
...
<script>
    ...
    modalPrintBtn.addEventListener('click', () => {
        ...
        printWindow.document.write(`<!DOCTYPE html><html><head><title>Cetak Kartu Siswa</title><style>
            .ktp-card {
                width: 85.6mm;
                height: 53.98mm;
                background: white;
