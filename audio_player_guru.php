...
// Proxy URL (sesuaikan dengan lokasi proxy)
...
// Ambil nama guru
$user_name = $_SESSION['user_name'] ?? 'Guru';
?>
<?php require_once __DIR__ . '/includes/header_user.php'; ?>
